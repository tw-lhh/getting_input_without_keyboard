...
def gesture_recognizing(fg1, fg2, fg3, fg4, fg00):
    ...
    if not (fg1 or fg2 or fg3 or fg4 or fg00):
        ...
        #按下對應的鍵位
        keyboard.press('0') #壓
        keyboard.release('0') #放

    elif fg1 and not (fg2 or fg3 or fg4 or fg00):
        number = 1
        print(str(number)+"\n")
        keyboard.press(str(number))
        keyboard.release(str(number))

    elif fg1 and fg2 and not (fg3 or fg4 or fg00):
        number = 2
        print(str(number)+"\n")
        keyboard.press(str(number))
        keyboard.release(str(number))

    elif fg1 and fg2 and fg3 and not (fg4 or fg00):
        number = 3
        print(str(number)+"\n")
        keyboard.press(str(number))
        keyboard.release(str(number))

    elif fg1 and fg2 and fg3 and fg4 and not (fg00):
        number = 4
        print(str(number)+"\n")
        keyboard.press(str(number))
        keyboard.release(str(number))

    elif fg1 and fg2 and fg3 and fg4 and fg00:
        number = 5
        print(str(number)+"\n")
        keyboard.press(str(number)) 
        keyboard.release(str(number))

    elif fg4 and fg00 and not (fg1 or fg2 or fg3):
        number = 6
        print(str(number)+"\n")
        keyboard.press(str(number))
        keyboard.release(str(number))

    elif fg1 and fg00 and not (fg2 or fg3 or fg4):
        number = 7
        print(str(number)+"\n")
        keyboard.press(str(number))
        keyboard.release(str(number))

    elif fg1 and fg2 and fg00 and not (fg3 or fg4):
        number = 8
        print(str(number)+"\n")
        keyboard.press(str(number))
        keyboard.release(str(number))

    elif fg1 and fg2 and fg00 and fg3 and not (fg4):
        number = 9
        print(str(number)+"\n")
        keyboard.press(str(number))
        keyboard.release(str(number))
...
while True:
    ...
    if ret:
        ...
        #make fps and show on the screen
        cTime = time.time()
        fps = 1/(cTime - pTime)
        pTime = cTime
